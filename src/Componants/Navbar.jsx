...
const Navbar = () => {
  return (
    <div className="navbar fixed top-0 left-0 z-30 w-full bg-transparent dark:bg-transparent backdrop-blur-md shadow-none">
      <div className="w-full px-6 flex justify-between items-center py-1">
        ...
        <div className="flex items-center gap-8">
          ...
          {/* WhatsApp Icon */}
          <a
            href="https://wa.me/?text=Hi, How are you?"
            target="_blank"
